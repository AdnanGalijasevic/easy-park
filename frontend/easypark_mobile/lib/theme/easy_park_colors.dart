...
/// EasyPark brand palette — keep in sync with `easypark_desktop/lib/theme/easy_park_colors.dart`.
abstract final class EasyParkColors {
  ...
  /// Secondary action green (e.g. profile save) — keep in sync with desktop.
  ...
  /// Text / icons one step below primary body (e.g. captions).
  static const Color textSecondary = Color(0xFF6B7280);

  /// Dark text on light surfaces (dropdowns, legacy light strips).
  ...
  /// Light blue wash (e.g. notification / bookmark tiles on light cards).
